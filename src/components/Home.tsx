    ...
    <div id="home">
      ...
      <div className="learn-more">
        <div className="learn-more-text">
          ...
          <p>
            In eu elementum orci. Praesent eu nunc a lacus aliquam laoreet sit
            amet ut metus. Nam facilisis est libero, vitae ullamcorper orci
            fermentum faucibus. Vivamus faucibus suscipit lorem. Ut ac dapibus
            magna. Fusce porta ullamcorper quam vel congue. Nullam quis nulla
            est. Nullam est erat, imperdiet quis egestas vel, lobortis quis
            odio. Phasellus maximus semper tempor. Etiam rutrum rhoncus mauris
            sit amet aliquam.
          </p>
